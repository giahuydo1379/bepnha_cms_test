...
use App\Http\Requests\Inside\TagGroupsRequest;
use App\MyCore\Inside\Routing\MyController;
use App\Http\Models\Inside\TagGroups;
use Illuminate\Http\Request;
use DB;

class TagGroupsController extends MyController
{
    private $_model = null;
    ...
    public function __construct() {
        ...
        $this->data['title'] = 'Setting Home';
        $this->data['controllerName'] = 'tag-groups';
        $this->_model = new TagGroups();
    }


    public function getShowAll() {
        $this->data['filters'] = session('taggroup_filters', [
            'offset' => 0,
    ...
    public function getAjaxData(Request $request)
    {
        ...
        session(['taggroup_filters' => $filter]);
    ...
    public function postAdd(TagGroupsRequest $request) {
    ...
    public function postEdit(TagGroupsRequest $request, $id) {
