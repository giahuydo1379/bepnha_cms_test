...
class DocumentsController extends MyController
{
    private $_model = null;
    ...
    public function __construct()
    {
        ...
        $this->data['title'] = 'Công thức nấu ăn';
        $this->data['controllerName'] = 'documents';
        $this->_model = new Documents();
    }
    ...
    public function getShowAll()
    {
        ...
        $this->data['pcategories'] = ['' => '- lọc theo danh mục chính -'] + Categories::getOptionsCategoryByTypeDocuments(1);
        $this->data['categories'] = ['' => '- lọc theo danh mục phụ -'] + Categories::getOptionsCategoryByTypeDocuments(2);
    ...
    public function getAjaxData(Request $request)
    {
        ...
        $data = $this->_model->getAllDocuments($filter);
