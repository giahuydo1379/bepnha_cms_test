...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Thống kê chi tiết lượt xem</li>
    </ol>
    ...
    <div id="page-content">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Thống kê chi tiết lượt xem</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-3">
						{{-- $filters['style'] ['viewdate'] la null --}}
                        {!! Form::select('style_filter', $style, null, [
                           'id' => 'style_filter',
                           'class' => 'custom_filter',
					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="input-daterange input-group" id="date_viewdate">
								<span class="input-group-addon">Chọn ngày</span>
								<input type="text" class="form-control" id="viewdate_filter" value="{{ null }}" placeholder="----- Chọn ngày -----" />

								{{--{!! Form::select('viewdate_filter', $viewdate, $filters['viewdate'], [
                           'id' => 'viewdate_filter',
                           'class' => 'custom_filter',
                           'data-placeholder' => 'Chọn ngày']) !!}--}}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-daterange input-group" id="date_from">
                                ...
                                <input type="text" class="form-control" id="from_filter" value="{{ null }}" placeholder="----- Ngày bắt đầu -----" />
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-daterange input-group" id="date_to">
                                ...
                                <input type="text" class="form-control" id="to_filter" value="{{ null }}" placeholder="----- Ngày kết thúc -----" />
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-1">
                ...
                <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
                        ...
                        data-url="{!! url("/{$moduleName}/{$controllerName}/ajax-data-detail") !!}"
                        data-search="true"
                        ...
                        data-cookie="true"
                        data-cookie-id-table="inside-detailreport-show-all"
                        data-cookie-expire="{!! config('params.bootstrapTable.extension.cookie.cookieExpire') !!}">
                    <thead>
                    <tr>
						<th data-field="post" data-sortable="true">Tên</th>
						<th data-field="style" data-sortable="true" data-formatter="formatStyle">Loại</th>
                        <th data-field="vd_view_count" data-sortable="true">Số lượt xem</th>
                    </tr>
                    </thead>
                </table>
				<a href='{!! url("/{$moduleName}/{$controllerName}/show-all"); !!}' class="btn btn-success btn-labeled fa fa-arrow-left pull-left">Về danh sách báo cáo</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
		...
		function queryParams(params) {
			...
			params.viewdate = $('#viewdate_filter').val();
		...
		$(document).ready(function() {
			...
			$('#reset-page').click(function () {
				...
				document.getElementById('viewdate_filter').value = '';
