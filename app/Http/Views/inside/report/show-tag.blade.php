...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Thống kê lượt xem theo Tag</li>
    </ol>
    ...
    <div id="page-content">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Thống kê lượt xem theo Tag</h3>
            </div>
            <div class="panel-body">
                ...
                <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
                        ...
                        data-url="{!! url("/{$moduleName}/{$controllerName}/ajax-data-tag") !!}"
                        data-search="true"
                        ...
                        data-cookie="true"
                        data-cookie-id-table="inside-tagreport-show-all"
                        data-cookie-expire="{!! config('params.bootstrapTable.extension.cookie.cookieExpire') !!}"
                >
                    <thead>
                    <tr>
                        <th data-field="title" data-sortable="true">Tag</th>
                        <th data-field="tag_view" data-sortable="true">Số lượt xem</th>
                    </tr>
                    </thead>
                </table>
