                        ...
                        <div id="mainnav-menu-wrap">
                            <div class="nano">
                                <div class="nano-content">
                                    <ul id="mainnav-menu" class="list-group" data-widget="tree">
                                        ...
                                        <li class="treeview<?php echo (in_array($controllerName, array('report'))) ? 'active-link active open' : '' ?>">
                                            {{--<a href="/inside/report/show-all">
                                                <i class="fa fa-table"></i>
                                                <span class="menu-title">
                                                    <strong>Báo cáo thống kê</strong>
                                                </span>
                                            </a>--}}
                                            <a href="#"> <i class="fa fa-table"></i> <span class="menu-title"><strong>Báo cáo Thống kê</strong></span></a>
                                            <ul class="treeview-menu">
                                                <li class="<?php echo (in_array($controllerName, array('report')) && in_array($actionNameDefault, array('getShowAll'))) ? 'active-link active open' : '' ?>">
                                                    <a href="/inside/report/show-all"><i class="fa fa-area-chart"></i><strong>Thống kê lượt xem theo Ngày</strong></a></li>
                                                <li class="<?php echo (in_array($controllerName, array('report')) && in_array($actionNameDefault, array('getShowDetail'))) ? 'active-link active open' : '' ?>">
                                                    <a href="/inside/report/show-detail"><i class="fa fa-area-chart"></i><strong>Thống kê lượt xem chi tiết</strong></a></li>
                                                <li class="<?php echo (in_array($controllerName, array('report')) && in_array($actionNameDefault, array('getShowTag'))) ? 'active-link active open' : '' ?>">
                                                    <a href="/inside/report/show-tag"><i class="fa fa-area-chart"></i><strong>Thống kê lượt xem theo Tag</strong></a></li>
                                            </ul>
                                        </li>
