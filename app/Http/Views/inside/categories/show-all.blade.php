...
@section('content')
    ...
    @if (Session::has('category-success-message'))
        <div class="alert alert-info alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <h4><i class="icon fa fa-check"></i> Thành công!</h4>
            {{ Session::get('category-success-message') }}
        </div>
    @elseif (Session::has('category-error-message'))
        <div class="alert alert-danger alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
            {{ Session::get('category-error-message') }}
        </div>
    @endif
    ...
    <div id="page-content">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-3">
                        {!! Form::select('status_filter', $status_opts, $filters['status'], [
                            'id' => 'status_filter',
                            'class' => 'custom_filter',
                    ...
                    <div class="col-sm-1">
                        <button id="reset-page" class="btn btn-default" type="button" name="refresh" title="Reset">Làm
                            lại
                        </button>
                    </div>
                </div>
                ...
                <div id="table-toolbar">
                    <button id="demo-delete-row" class="btn btn-danger btn-labeled fa fa-times" disabled>Đổi trạng
                        thái
                    </button>
                    <a href="{!! url("/{$moduleName}/{$controllerName}/add") !!}"
                       class="btn btn-primary btn-labeled fa fa-plus">Thêm</a>
                </div>
                ...
                >
                    ...
                    <tr>
                        ...
                        <th data-field="name" data-sortable="true">Tên Category</th>
                        {{--
                        <th data-field="parent_category_name" data-sortable="true">Parent Category</th>
                        --}}
                        <th data-field="date_created" data-sortable="true">Ngày tạo</th>
                        <th data-field="disable" data-align="center" data-sortable="true"
                            data-formatter="formatDisable">
                            Trạng thái
                        </th>
                        <th data-field="style" data-align="center" data-sortable="true" data-formatter="formatStyle">
                            Dạng bài
                        </th>
