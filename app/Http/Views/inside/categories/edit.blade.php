        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text("name", $object['name'], ['class' => 'form-control' , "id" => "name", 'required' => "required"]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::select("type", $cat_types, $object['type'], ['class' => 'form-control', 'required' => "required" ]) !!}
                        <span class="help-block has-error">{!! $errors->first("type") !!}</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::select("style", $cat_styles, $object['style'], ['class' => 'form-control', 'required' => "required" ]) !!}
                        <span class="help-block has-error">{!! $errors->first("style") !!}</span>
                    </div>
                </div>
