                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-3" style="margin-left: 18px;">
                                    <div class="form-group">
                                        <label class="control-label"><strong>Thời gian video</strong> <span
                                                    class="symbol required"></span></label>
                                        {!! Form::text("duration", $object['duration'], ['class' => 'form-control' , "id" => "video_duration", "placeholder" => 'VD: 05:00', "data-timepicker"]) !!}
                                ...
                                <div class="col-sm-3" style="margin-left: 40px;">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text("time_to_done", $object['time_to_done'], ['class' => 'form-control' , "id" => "time_to_done", "placeholder" => 'VD: 05:00', "data-timepicker"]) !!}
