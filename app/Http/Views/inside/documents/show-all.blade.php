...
<ol class="breadcrumb">
    ...
    <li class="active">Danh sách Công thức nấu ăn</li>
</ol>
...
<div id="page-content">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Danh sách Công thức nấu ăn</h3>
        </div>
            ...
            <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="time_to_done" data-sortable="true">Thời gian hoàn thành</th>
