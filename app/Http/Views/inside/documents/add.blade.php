                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group" style="clear: both">
                                ...
                                {!! Form::text("title", null, ['class' => 'form-control' , "id" => "title", "placeholder" => 'Nhập tên Công thức nấu ăn', 'required' => "required"]) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea("content", null, ['class' => 'form-control' , "id" => "content", "placeholder" => 'Nhập công thức', 'required' => "required"]) !!}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label"><strong>Thể loại chính</strong><span
                                                class="symbol required"></span></label>
                                    {!! Form::select("pcategory_id", $pcategories, null, ['class' => 'form-control' , "id" => "pcategory_id" ,'required' => "required"]) !!}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label"><strong>Thể loại phụ</strong><span
                                                class="symbol required"></span></label>
                                    {!! Form::select("category_id", $categories, null, ['class' => 'form-control' , "id" => "category_id", 'required' => "required"]) !!}
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number("level", null, ['class' => 'form-control' , "id" => "level", "min"=>'1', "max"=> '5', "placeholder" => '1,2 or 3', 'required' => "required"]) !!}
