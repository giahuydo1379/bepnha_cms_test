...
$config['LicenseName'] = 'Me';
$config['LicenseKey'] = 'Me';
...
*/
//nay la config cho luu ma a nghi la /root la dc r xe lai loi
//$baseUrl = 'http://bepnha.tv.local/upload/images/ckfinder/userfiles/';
//$baseUrl = '/userfiles/';
$baseUrl = 'http://static.bepnha.local/';
...
ATTENTION: The trailing slash is required.
*/
//$uploadFolder = isset($_SESSION['uploadFolder']) ? $_SESSION['uploadFolder'] : '';
//$baseDir = dirname(__FILE__) . "/../../../../upload/images";
$baseDir = '/mnt/bepnha/images';
